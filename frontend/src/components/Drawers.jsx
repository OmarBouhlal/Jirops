...
export function CreateTaskDrawer({ isOpen, onClose, onSubmit, sprints, taskForm, setTaskForm, busy }) {
  ...
  return (
    <BaseDrawer isOpen={isOpen} onClose={onClose} title="Create Task">
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <label className="block">
          <span className="mb-1.5 block text-sm font-medium text-slate-200">Assignee UUID</span>
          <input
            type="text"
